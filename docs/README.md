...
Prose docs live here; the project README and `CLAUDE.md` stay at the repo root, and
image/GIF assets live in [`../assets/`](../assets).
...
Per-tool docs sit beside their code as `tools/<name>/README.md` (e.g.
[`../tools/web/README.md`](../tools/web/README.md), [`../tools/email/README.md`](../tools/email/README.md)).
